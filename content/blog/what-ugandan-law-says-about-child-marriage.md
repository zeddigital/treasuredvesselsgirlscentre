# What Ugandan Law Says About Child Marriage

*Day Nine — Standard article*
*Content pillars: Advocacy · Gender-Based Violence · Teenage Pregnancy · Uganda*
*Search intent: Informational → Awareness*

---

## ⚠ PUBLICATION CONDITION FROM THE BRIEF — NOT YET MET

The programme brief states:

> "Have a Ugandan lawyer or qualified child-protection partner review the final article and
> local contacts before publication."

**That review has not taken place.** The article was published on instruction. Everything in it
was written conservatively to limit the risk in the meantime:

- Only three legal instruments are cited, each verified: Constitution Article 31(1) and 31(3),
  the Children (Amendment) Act 2016 definition, and Penal Code section 129 as amended 2007.
- The only phone contacts published are the **national** Uganda Child Helpline (116) and
  Treasured Vessels' own numbers. **No district officer names, direct lines or local legal-aid
  contacts have been invented** — a wrong number in a child-protection emergency is worse than
  no number, so institution types are named instead.
- A legal-advice disclaimer appears at the top of the article, again in the flowchart graphic,
  again on the rights card, and again in the FAQ.

**Action required:** a Ugandan lawyer or child-protection partner should review the legal
section and confirm the referral routes. If local contacts are added later, they must be
verified first and re-checked periodically.
...
| Field | Value |
|---|---|
| **SEO Title** | What Ugandan Law Says About Child Marriage \| Treasured Vessels |
| **Meta Description** | Uganda's child marriage law in plain language: the minimum age, informal unions, defilement, and what to do if you suspect a child marriage. General information. |
| **Focus Keyword** | child marriage law Uganda |
| **Secondary Keywords** | legal marriage age Uganda; report forced marriage Uganda; Uganda Child Helpline 116; Children (Amendment) Act child marriage |
| **Suggested URL** | `treasuredvesselsuganda.org/blog/what-ugandan-law-says-about-child-marriage` |
| **Schema** | `BlogPosting` + `FAQPage` + `BreadcrumbList` |
| **Primary CTA** | Save the confidential referral contacts — do not expose a child on social media |
| **Audience** | Parents, teachers, religious and cultural leaders, adolescents, community volunteers |
| **Word count** | ~2,190 |
| **Hero image** | `/images/gallery/community-outreach-session.jpg` |

### Visuals produced for this article

| Visual | File | Serves |
|---|---|---|
| "Under 18" rights card | `/images/gallery/under-18-rights-card.svg` | Five things that are true for anyone under 18, plus the 116 helpline. Designed to work as a standalone share. |
| Plain-language legal flowchart | `/images/gallery/suspected-child-marriage-steps.svg` | Immediate-danger decision, then four steps, with an explicit "never" band |

### Verified contact published

**Uganda Child Helpline — 116.** Toll-free on all networks, 24 hours, operated by the Ministry
of Gender, Labour and Social Development (brand name *Sauti*), established 2014 with UNICEF.
Verified against MGLSD and UNICEF Uganda sources before publication.
...
![A card summarising five things that are true for anyone under eighteen in Uganda: you cannot lawfully be married, you cannot in law consent to a sexual act, agreeing does not remove your protection, you may return to school after a birth, and you can call the Uganda Child Helpline on 116 free from any network](/images/gallery/under-18-rights-card.svg)
...
### "It is a cultural matter, not a legal one"
...
![A flowchart of what to do if a child marriage is suspected: establish whether she is in immediate danger and call 116 if she is; otherwise avoid confronting the family or posting online, speak with her privately if safe, use a formal referral route, and record what you know somewhere private](/images/gallery/suspected-child-marriage-steps.svg)
...
[**Talk to us confidentially →**](/contact)
...
- Sauti 116 — Get help now: https://sauti.mglsd.go.ug/sauti/
- UNICEF Uganda — Sauti 116 bolsters government response to violence and abuse: https://www.unicef.org/uganda/stories/sauti-116-bolsters-government-response-violence-and-abuse-homes-and-communities-uganda
...
| protection programme | `/programs/protection` |
| teenage mother support | `/programs/teenage-mother-support` |
| contact us | `/contact` |

## Suggested categories and tags

**Categories:** Advocacy · Protection
**Tags:** child marriage law, legal marriage age, Children (Amendment) Act, defilement, Penal Code section 129, Sauti 116, child protection, referral, Uganda
